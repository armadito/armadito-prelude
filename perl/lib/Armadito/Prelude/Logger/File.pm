package Armadito::Prelude::Logger::File;
...
sub new {
	...
	my $self = {
		...
		logfile_maxsize => $params{config}->{'logfile-maxsize'} ? $params{config}->{'logfile-maxsize'} * 1024 * 1024 : 0
	};
	bless $self, $class;
...
Armadito::Prelude::Logger::File - A file backend for the logger
